...
PARQUET_DIR = r"c:\Users\thzin\Desktop\EDScript_\archive\out_parquet_optimized"

def load_matches_to_neon(limit_files=None):
    """
    ...
    try:
        ...
        print(f"\n✓ Total: {inseridos} partidas inseridas em tb_partida_historico")
